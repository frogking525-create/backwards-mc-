 ...
 *
 * MAPPING CHECKPOINT: the dragon-fight class is used here as "EndDragonFight" (Mojang's official
 * name for the class Yarn called "EnderDragonFight"). If this doesn't compile, open
 * ServerLevel in your IDE, find the method that returns the dragon fight object, and check
 * what it's actually called/returns in your exact build.
 */
public final class PortalGuard {
    ...
    public static void punishIfEarlyPortal(ServerLevel world, BlockPos ignitionPos) {
        ...
        if (foundPortal) {
            ...
            // MAPPING CHECKPOINT (second highest risk line): explosion API signatures have
            // changed repeatedly even within the obfuscated era. If Level#explode doesn't match
            // this signature, look up the current one on Level in your IDE - any "make an
            // explosion at this position with this power" call works here.
